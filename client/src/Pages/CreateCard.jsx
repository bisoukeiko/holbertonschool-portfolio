...
function CreateCard() {
    ...
    const [selectedIdChild, setSelectedIdChild] = useState('');
        ...
        if (userId) {
            ...
            if (selectedParty) {
                ...
                .then(res => {
                    ...
                    setSelectedIdChild(res.data[0].idChild);
    ...
    useEffect(() => {
        if (selectedIdChild) {
            axios.get(`http://localhost:5000/party/selectByIdChild`, {params: { childId: selectedIdChild }})
            .then(res => {
    ...
    const handleSelect = (childData) => {
        setSelectedIdChild(childData.idChild);
        ...
        <div>
            <nav aria-label='breadcrumb' className='ms-5 mt-4 mb-3'>
                <ol className='breadcrumb'>
                    ...
                    <li className='breadcrumb-item'><Link to='/party' state={{ partyId: selectedParty }}>Party</Link></li>
                    <li className='breadcrumb-item active' aria-current='page'>Create Invitations</li>
                </ol>
            </nav>
